...
홈, 프로젝트 소개, 아카이브와 게시물 상세 화면을 운영하고 있습니다. 게시물에서는 링크·인용 정보 복사, 공유, 인쇄·PDF 저장을 지원하며 운영체제의 동작 줄이기 설정을 반영합니다. GitHub 품질 검사를 통과한 커밋은 Cloudflare Pages에 배포되며 프로덕션 스모크 테스트로 주요 경로를 확인합니다.
...
pnpm validate:rss       # RSS 항목·분류·대표 이미지 메타데이터 검사
